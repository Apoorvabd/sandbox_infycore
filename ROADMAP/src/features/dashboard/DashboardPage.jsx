    ...
    useEffect(() => {
        ...
        const fetchDashboardData = async () => {
            ...
            try {
                ...
                if (isMounted) {
                    // Extract payload using response.data if ApiResponse wrapped, or assume it's directly there
                    dispatch(setSummary(summaryRes.data || summaryRes));
                    dispatch(setCategoryBreakdown(categoryRes.data || categoryRes));
                    dispatch(setCashflow(cashflowRes.data || cashflowRes));
                    dispatch(setRecentTransactions(recentRes.data || recentRes));
                }
            } catch (err) {
                if (isMounted) {
