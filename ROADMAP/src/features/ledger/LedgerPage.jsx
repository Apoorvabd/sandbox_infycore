...
export default function LedgerPage() {
        ...
        try {
            ...
            dispatch(
                setTransactions({
                    ...
                    totalCount: txData.total_count ?? txData.totalCount ?? 0,
                })
            );
    ...
    return (
        <div className="space-y-6">
            <PageHeader
                title="Ledger"
                description="Full transaction history with filtering, sorting, and pagination."
                actions={
                    hasActiveFilters && (
                        <button
                            onClick={handleReset}
                            className="flex items-center gap-1.5 text-xs text-slate-400 hover:text-red-400 border border-slate-700 hover:border-red-500/40 px-3 py-1.5 rounded-lg transition-all"
                        >
            ...
            {summary && (
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {[
                        ...
                        { label: "Total Credits", value: fmt(summary.total_credits) },
                        { label: "Total Debits", value: fmt(summary.total_debits) },
