...
export default function AnomalyPage() {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            dispatch(setAuditFeed(feedRes.data ?? feedRes));
            dispatch(setAnomalyStats(statsRes.data ?? statsRes));
        } catch (err) {
    ...
    const handleRunDetection = async () => {
        ...
        try {
            ...
            const detected = (res.data ?? res)?.detected ?? "?";
    ...
    const total = stats?.total ?? auditFeed.length;
