...
export default function RulesPage() {
    ...
    const fetchRules = useCallback(async () => {
        ...
        try {
            ...
            dispatch(setRules(toArray(extractApiData(res))));
        } catch (err) {
    ...
    const handleSave = async (formData) => {
        try {
            if (editingRule) {
                ...
                dispatch(updateRuleInState(extractApiData(res) ?? {}));
                toast.success("Rule updated successfully");
            } else {
                const res = await rulesApi.create(formData);
                dispatch(addRule(extractApiData(res) ?? {}));
    ...
    const handleReprocess = async () => {
        ...
        try {
            ...
            const count = extractApiData(res)?.updated ?? "all";
    ...
    const handleTest = async () => {
        ...
        try {
            ...
            setTestResult(extractApiData(res) ?? {});
        } catch (err) {
